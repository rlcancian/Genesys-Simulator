...
- `genesys_plugin_target_introspection_evidence_20260721.md`: generated CMake File API target, source, consumer, and GLPK evidence.
- `genesys_plugin_target_link_evidence_20260722.md`: generated GLPK-present/absent archive-symbol and final-link evidence.
