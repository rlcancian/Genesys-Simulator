...
\subsection{Why this is architecturally important}
...
\section{An integrated reading of the kernel}
...
\begin{table}[htbp]
 \centering
 \caption{Roles of the core classes in the GenESyS kernel.}
 ...
 \hline
 \texttt{ModelSimulation} & Control of execution, repetitions, simulated time, termination conditions and events \\
 \hline
