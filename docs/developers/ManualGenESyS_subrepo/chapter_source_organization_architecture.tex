...
\begin{table}[htbp]
 ...
 \hline
 Parser and extensibility & Expression interpretation, simulator language and extension by \textit{plugins} \\
 \hline
...
The \texttt{Simulator} class provides a particularly useful synthesis of this overview. It presents itself as the highest level class of the simulation kernel and exposes several central system managers. These include \texttt{PluginManager}, \texttt{ModelManager}, \texttt{TraceManager}, \texttt{ParserManager}, and \texttt{ExperimentManager}.
