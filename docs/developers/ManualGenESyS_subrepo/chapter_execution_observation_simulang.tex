...
For the user, the main consequence is this: execution should not be seen as just \enquote{pressing the start button}. It should be understood as the passage from the model description to its operational dynamics.
...
\hline
Read the \textit{Simulang} tab & Relate the graphic model to its textual description \\
\hline
