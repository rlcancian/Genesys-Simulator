...
- `docs/users/` contains user-facing documentation inputs and generated Doxygen output.
- `docs/developers/` contains developer-facing documentation inputs and generated Doxygen output.
