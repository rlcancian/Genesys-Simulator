...
>
> AI assistants working on this repository should also read `docs/ai_assistants/README.md` before proposing or editing code, documentation, CI, build scripts, tests, packaging files, or architecture.
...
├── docs/
│   └── ai_assistants/
├── documentation/          # legacy documentation tree; migration to docs/ is in progress
├── docker/
├── models/
├── source/
│   ├── applications/
...
- `documentation/` is the legacy documentation tree and remains present until the migration to `docs/` is completed.
