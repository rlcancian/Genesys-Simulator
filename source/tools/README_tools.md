...
- Fitting is still represented by a dummy default in traits (`FitterDummyImpl`).
...
- **Fitting**: interface defined, default still placeholder/dummy in production trait binding.
