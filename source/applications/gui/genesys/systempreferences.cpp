...
SystemPreferences::InterfaceStyle SystemPreferences::_interfaceStyle = SystemPreferences::InterfaceStyle::Modern;
...
void SystemPreferences::resetToDefaults() {
    ...
    _traceLevel = TraceManager::Level::L7_internal;
    _visualTheme = VisualTheme::Light;
    _interfaceStyle = InterfaceStyle::Modern;
