...
void MainWindow::on_actionToolsWebWorker_triggered() {
    ToolLauncher::launchDetached(this,
                                 QStringLiteral("genesys-httpworker-gui"),
                                 tr("Web Worker"),
                                 {},
                                 {QStringLiteral(".."),
                                  QStringLiteral("../httpworker"),
                                  QStringLiteral("../../../../../gui-httpworker/source/applications/gui/httpworker")});
}
