...
void DialogUtilityController::onActionToolsOptimizatorTriggered() {
    ToolLauncher::launchDetached(_ownerWidget,
                                 QStringLiteral("genesys-optimizer-gui"),
                                 QObject::tr("Optimizer"),
                                 {},
                                 {QStringLiteral(".."),
                                  QStringLiteral("../optimizer"),
                                  QStringLiteral("../../../../../gui-optimizer/source/applications/gui/optimizer")});
}
...
void DialogUtilityController::onActionToolsAIAssistantTriggered() {
    ToolLauncher::launchDetached(_ownerWidget,
                                 QStringLiteral("genesys-ai-assistant-gui"),
                                 QObject::tr("AI Assistant"),
                                 {},
                                 {QStringLiteral(".."),
...
void DialogUtilityController::onActionToolsDataAnalyzerTriggered() {
    ToolLauncher::launchDetached(_ownerWidget,
                                 QStringLiteral("genesys-dataanalyser-gui"),
                                 QObject::tr("Data Analyzer"),
                                 {},
                                 {QStringLiteral(".."),
                                  QStringLiteral("../dataanalyser"),
                                  QStringLiteral("../../../../../gui-dataanalyser/source/applications/gui/dataanalyser")});
}
