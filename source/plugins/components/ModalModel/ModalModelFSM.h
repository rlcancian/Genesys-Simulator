...
protected: /// virtual protected methods that could be overriden by derived classes, if needed
	virtual DefaultNodeTransition* _createTransitionForLoad(DefaultNode* source, DefaultNode* destination, const std::string& transitionTypename, const std::string& transitionName, PersistenceRecord* fields, const std::string& suffix) override;
	virtual std::string _getTransitionTypename(DefaultNodeTransition* transition) const override;
	virtual void _loadTransitionSpecificFields(DefaultNodeTransition* transition, PersistenceRecord* fields, const std::string& suffix) override;
	virtual void _saveTransitionSpecificFields(DefaultNodeTransition* transition, PersistenceRecord* fields, const std::string& suffix, bool saveDefaultValues) override;
